 ...
 * @var string $queryClassName query class name from the specified model class name
 * @var array $enum ENUM field values
*/
...
if ($queryClassName) {
    if($generator->ns !== $generator->queryNs){
        echo "use $generator->queryNs" . '\\' . "$queryClassName;\n";
    }
} ?>
...
<?php endif; ?>
 */
abstract class <?= $className ?> extends <?= '\\' . ltrim($generator->baseClass, '\\') . PHP_EOL ?>
{
<?php
$traits = $generator->baseTraits;
if ($traits) {
    echo "use {$traits};" . PHP_EOL;
}
if (!empty($enum)) {
    ?>
    /**
...
foreach ($relations as $name => $relation): ?>
    ...
    /**
     * @return \<?=$ns?>\query\<?=$relation[1]?>Query
     */
